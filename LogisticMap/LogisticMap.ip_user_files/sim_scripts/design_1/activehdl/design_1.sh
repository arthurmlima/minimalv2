...
#
# Script generated by Vivado on Fri Jan 02 23:48:30 +0000 2026
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/Users/arthu/minimalv2/LogisticMap/LogisticMap.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
