...
REM
REM Generated by Vivado on Tue Jan 06 16:03:51 +0000 2026
...
echo "xvhdl --incr --relax -prj tb_example_vhdl.prj"
call xvhdl  --incr --relax -prj tb_example_vhdl.prj -log xvhdl.log
