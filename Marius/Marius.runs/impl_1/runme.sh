...
HD_PWD='C:/Users/arthu/Marius/Marius.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log MariusMethod_25.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source MariusMethod_25.tcl -notrace
