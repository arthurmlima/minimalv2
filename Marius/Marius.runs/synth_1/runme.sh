...
HD_PWD='C:/Users/arthu/Marius/Marius.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MariusMethod_25.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MariusMethod_25.tcl
